...
import com.chryl.redisson.serializer.redis.FstRedisSerializer;
...
//        redisCacheConfigurationMap.put("UserInfoListAnother", this.getRedisCacheConfigurationWithTtl(18000));
    ...
    /**
     * fst序列化的redisTemplate
     *
     * @param redisConnectionFactory
     * @return
     */
    @Bean
    public RedisTemplate<String, Object> fstRedisTemplate(RedisConnectionFactory redisConnectionFactory) {
